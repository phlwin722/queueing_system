          ...
          <q-tab-panels v-model="tab" animated>
            ...
            <q-tab-panel name="info">
              <q-form @submit="saveChanges">
                ...
                <div class="q-mt-lg">
                  <q-btn label="Save Changes" @click="UpdateAdmin" color="positive" class="q-pa-xs" />
                </div>
              </q-form>
            </q-tab-panel>
            ...
            <q-tab-panel name="password">
              <q-form @submit="changePassword">
                ...
                <div class="q-mt-lg">
                  <q-btn label="Change Password" @click="updatePassword" color="positive" class="q-pa-xs" />
                </div>
              </q-form>
            </q-tab-panel>
  ...
  export default {
    setup() {
      ...
      const updatePassword = async () => {
        console.log(adminPassword.value.newPassword);
