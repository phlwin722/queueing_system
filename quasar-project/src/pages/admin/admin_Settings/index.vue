                ...
                <q-tab-panel name="info">
                    <q-form @submit="saveChanges">
                        <div class="row q-col-gutter-md">
                            <q-input filled v-model="username" placeholder="fetch admin username" hint="Username" :dense="dense" class="col-12 col-md-4"/>
                            <q-input filled v-model="firstname" placeholder="fetch admin firstname" hint="First Name" :dense="dense" class="col-12 col-md-4"/>
                            <q-input filled v-model="lastname" placeholder="fetch admin lastname" hint="Last Name" :dense="dense" class="col-12 col-md-4"/>
                        </div>

                        <div class="q-mt-xl text-right">
                            <q-btn label="Save Changes" type="submit" color="positive" class="q-pa-xs" style="width: 125px; margin-right: 10px;"/>
                            <q-btn label="Cancel" color="negative" class="q-pa-xs" style="width: 75px;"/>  
                        </div>
                    </q-form>
                </q-tab-panel>
