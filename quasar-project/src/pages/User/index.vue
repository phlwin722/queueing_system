<template>
  <q-layout
    view="lHh lpr lFf"
    class="shadow-2 rounded-borders scrollable-container"
  >
    <div class="absolute-center full-width full-height bg-grey-2">
      ...
      >
        ...
        <!-- Queue List -->
        <q-card
          class="col-12 full-width shadow-3 bg-white rounded-borders q-pa-md q-mb-xl"
        >
          ...
          <div
            v-if="isWaiting && queuePosition === 1 && !isBeingServed"
            class="text-center text-negative q-mb-md"
          >
            <q-icon name="hourglass_empty" size="sm" />
            The admin is waiting. Please proceed. If not, your queueing number
    ...
    const startCountdown = () => {
      if (!countdownInterval) {
        ...
        $notify(
          "warning",
          "hourglass_empty",
          "The admin is waiting for you! Please proceed."
        );
