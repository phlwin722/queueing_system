<template>
  <q-page class="q-px-sm" style="height: auto; min-height: unset">
    ...
    <div class="q-px-md q-mt-md">
      <div
        class="q-pa-md row justify-around bg-white-2 rounded-borders shadow-2"
      >
        <!-- Finished Customers -->
...
export default defineComponent({
  ...
  setup() {
    ...
    const generatePDF = async () => {
      try {
        ...
        const addHeader = () => {
          ...
          const logoPath = require("assets/queueappblock.png");
        ...
        doc.addImage(
          ...
          iconSize,
          iconSize
        ); // Add check icon (X, Y, width, height)
    ...
    watch(
      [type_id, fromDate, toDate, branch_value],
      (
        [newTypeId, newFromDate, newToDate, newBranch],
        [oldTypeId, oldFromDate, oldToDate, oldBranch]
      ) => {
