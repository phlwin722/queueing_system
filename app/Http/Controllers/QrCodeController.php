...
class QrCodeController extends Controller
{
    ...
    public function generateQrCode()
    {
        ...
        $qrCode = \DB::table('qr_codes')->where('used', false)->latest()->first();
    ...
    public function scanQrCode(Request $request)
    {
        ...
        $qrCode = \DB::table('qr_codes')->where('token', $token)->first();
        ...
        // Mark QR as used
        \DB::table('qr_codes')->where('token', $token)->update(['used' => true]);
